onload = function()
 {
	 ...
	 $html.onclick = function(e)
	 {
		 ...
		 switch (++click_cnt)
		 {
			 ...
			 case 50: $elem.innerText = "（￣へ￣）";
			 break; case 60: $elem.innerText = "(╯°口°)╯(┴—┴"; break;
			 case 70: $elem.innerText = "૮( ᵒ̌皿ᵒ̌ )ა"; break;
			 case 80: $elem.innerText = "╮(｡>口<｡)╭"; break
			 case 90: $elem.innerText = "( ง ᵒ̌皿ᵒ̌)ง⁼³₌₃"; break;
			 case 100: $elem.innerText = "%%%"; break;
			 case 101: $elem.innerText = "TQL"; break;
			 case 102:
			 case 103:
			 case 104: 
			 case 105: $elem.innerText = "(ꐦ°᷄д°᷅)"; break; 
			 case 520: $elem.innerText = "❤520❤嘻嘻"; break; 
